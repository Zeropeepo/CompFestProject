          ...
          <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-x-12 gap-y-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input type="tel" id="phone" value={phone} onChange={e => setPhone(e.target.value)} className="form-input" required />
              </div>
              <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea id="allergies" value={allergies} onChange={e => setAllergies(e.target.value)} rows={3} className="form-input"></textarea>
              </div>
